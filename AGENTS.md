...
- `docs/contracts/openapi.yaml` defines the public API boundary.
- `docs/policies/source-rights.md` defines default rights and ingestion behavior.
- `docs/plans/2026-03-06-newslayer-v0-foundation.md` defines current product scope and v0 boundary.
